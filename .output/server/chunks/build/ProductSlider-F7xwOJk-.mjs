...
import _sfc_main$3 from './svg-icon-CbNtY1Rj.mjs';
...
import { _ as __nuxt_component_1$1 } from './InputNumber-CJP0DsGA.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "swiper" }, _attrs))} data-v-0fbf708f><swiper-container class="product-slider" slides-per-view="1"${ssrRenderAttr("breakpoints", {
    500: {
      slidesPerView: 2
    },
    768: {
  ...
  })} mousewheel="false" allow-touch-move="true" space-between="60" data-v-0fbf708f><!--[-->`);
  ssrRenderList($props.cards, (item, index) => {
    _push(`<swiper-slide class="product-slider__item" data-v-0fbf708f>`);
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-0fbf708f"]]);

export { __nuxt_component_1 as _, __nuxt_component_2 as a, __nuxt_component_0 as b };
//# sourceMappingURL=ProductSlider-F7xwOJk-.mjs.map
