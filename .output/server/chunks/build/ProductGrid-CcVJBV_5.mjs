...
import _sfc_main$7 from './svg-icon-CbNtY1Rj.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link-P6SDANQl.mjs';
import { b as __nuxt_component_0$2 } from './ProductSlider-F7xwOJk-.mjs';
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if ($props.isToggle) {
    _push(`<div${ssrRenderAttrs(mergeProps({ class: "drop-down drop-down_toggle" }, _attrs))} data-v-6cdd621a><button class="drop-down__btn" type="button" data-v-6cdd621a><span data-v-6cdd621a>${ssrInterpolate($props.title)}</span>`);
    ...
    _push(`<div${ssrRenderAttrs(mergeProps({ class: "drop-down" }, _attrs))} data-v-6cdd621a><button class="drop-down__btn" data-v-6cdd621a><span data-v-6cdd621a>${ssrInterpolate($props.title)}</span>`);
    ...
    _push(`</button>`);
    if ($data.isOpen) {
      _push(`<div class="drop-down__content" data-v-6cdd621a><ul class="${ssrRenderClass([{ "drop-down-list_flex": $props.isFlex }, "drop-down-list"])}" data-v-6cdd621a><!--[-->`);
      ssrRenderList($props.list, (item, index) => {
        _push(`<li class="drop-down-list__item" data-v-6cdd621a>`);
        if ($props.isLink) {
          _push(ssrRenderComponent(_component_nuxt_link, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                _push2(`<span data-v-6cdd621a${_scopeId}>${ssrInterpolate(item.name)}</span>`);
              } else {
                return [
      ...
      _push(`<!--]--></ul>`);
      if ($props.showMore) {
        _push(`<button class="drop-down__btn-more" data-v-6cdd621a>\u043F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0435\u0449\u0451</button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-6cdd621a"]]);
const _sfc_main = {
  props: {
    productList: {
      type: Array,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<ul${ssrRenderAttrs(mergeProps({ class: "product-grid" }, _attrs))} data-v-ede0b8d1><!--[-->`);
  ssrRenderList($props.productList, (product, index) => {
    _push(`<li class="${ssrRenderClass([{ "span-2": product.span }, "product-grid__item"])}" data-v-ede0b8d1>`);
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-ede0b8d1"]]);

export { __nuxt_component_2 as _, __nuxt_component_3 as a };
//# sourceMappingURL=ProductGrid-CcVJBV_5.mjs.map
