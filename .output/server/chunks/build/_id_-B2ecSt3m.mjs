import { _ as __nuxt_component_0$1 } from './Breadcrumbs-WWgVILK3.mjs';
import { _ as __nuxt_component_0$2 } from './TheSection-oCR6a-xp.mjs';
import { b as __nuxt_component_2, _ as __nuxt_component_3 } from './ProductSideBar-CkIUmbR0.mjs';
import _sfc_main$4 from './svg-icon-BRgkTEyW.mjs';
...
import { _ as __nuxt_component_3$2 } from './Pagination-D-3qMP2z.mjs';
import { _ as __nuxt_component_2$1 } from './Button-DuwhWeWl.mjs';
import { _ as __nuxt_component_3$1, a as __nuxt_component_4$1 } from './ProductSlider-DdJX8s6V.mjs';
...
import 'node:fs';
import 'node:url';
import './InputNumber-CwHbo-NJ.mjs';
import 'unhead';
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_ui_pagination = __nuxt_component_3$2;
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_app_title = __nuxt_component_3$1;
  const _component_product_slider = __nuxt_component_4$1;
  _push(`<main${ssrRenderAttrs(mergeProps({ class: "main" }, _attrs))} data-v-95fbf2d1>`);
  ...
  _push(ssrRenderComponent(_component_the_section, { class: "product-section" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h1 class="h1" data-v-95fbf2d1${_scopeId}>\u041A\u043B\u0435\u0449\u0438 \u043F\u0435\u0440\u0435\u0441\u0442\u0430\u0432\u043D\u044B\u0435 Sparta 250 \u043C\u043C</h1><div class="product-section__wrap" data-v-95fbf2d1${_scopeId}><div class="product-section__slider" data-v-95fbf2d1${_scopeId}><swiper-container class="product-section__slider-container" slides-per-view="1" pagination="true" data-v-95fbf2d1${_scopeId}><!--[-->`);
        ssrRenderList($data.images, (item, index) => {
          _push2(`<swiper-slide class="product-section__slider-item" data-v-95fbf2d1${_scopeId}><div class="product-section__img" data-v-95fbf2d1${_scopeId}><img${ssrRenderAttr("src", item)} alt="" data-v-95fbf2d1${_scopeId}></div></swiper-slide>`);
        });
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-95fbf2d1"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-B2ecSt3m.mjs.map
