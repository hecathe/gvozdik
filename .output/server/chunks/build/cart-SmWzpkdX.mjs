...
import _sfc_main$2 from './svg-icon-BopcabGT.mjs';
import { _ as __nuxt_component_3$1, a as __nuxt_component_2$1 } from './ProductSideBar-9ImDIPcv.mjs';
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "cart-item" }, _attrs))} data-v-1c69d0a4><div class="cart-item__img" data-v-1c69d0a4><img${ssrRenderAttr("src", $props.cartItem.img)} alt="" data-v-1c69d0a4></div><div class="cart-item__wrap" data-v-1c69d0a4><div class="cart-item__block" data-v-1c69d0a4><div class="cart-item__left" data-v-1c69d0a4><h3 data-v-1c69d0a4>${ssrInterpolate($props.cartItem.title)}</h3><p data-v-1c69d0a4>\u0410\u0440\u0442\u0438\u043A\u0443\u043B: ${ssrInterpolate($props.cartItem.article)}</p><p data-v-1c69d0a4>\u0412\u0435\u0441: ${ssrInterpolate($props.cartItem.weight)}</p></div><div class="cart-item__right cart-item__right_grid" data-v-1c69d0a4><p class="cart-item__sum" data-v-1c69d0a4>${ssrInterpolate($props.cartItem.summary)} \u20BD</p><p class="cart-item__price" data-v-1c69d0a4>${ssrInterpolate($props.cartItem.price)}</p></div></div><div class="cart-item__block" data-v-1c69d0a4><div class="cart-item__left cart-item__col" data-v-1c69d0a4>`);
  _push(ssrRenderComponent(_component_ui_button_like, {
    class: "cart-item__btn",
    width: "24",
    height: "24"
  }, null, _parent));
  _push(`<button class="cart-item__btn cart-item__delete" data-v-1c69d0a4>`);
  _push(ssrRenderComponent(_component_svg_icon, {
    name: "trash",
    width: "24",
    height: "24"
  }, null, _parent));
  _push(`</button></div><div class="cart-item__right" data-v-1c69d0a4>`);
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-1c69d0a4"]]);
const _sfc_main = {
  data() {
    return {
      cart_list: [
...
//# sourceMappingURL=cart-SmWzpkdX.mjs.map
