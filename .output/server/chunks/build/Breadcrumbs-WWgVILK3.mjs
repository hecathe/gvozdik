...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_the_section, mergeProps({ class: "breadcrumbs" }, _attrs), {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<ul class="breadcrumbs__list" data-v-66895e3b${_scopeId}><!--[-->`);
        ssrRenderList($props.breadcrumbs, (breadItem, index) => {
          _push2(`<li class="breadcrumbs__item" data-v-66895e3b${_scopeId}>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-66895e3b"]]);

export { __nuxt_component_0 as _ };
//# sourceMappingURL=Breadcrumbs-WWgVILK3.mjs.map
