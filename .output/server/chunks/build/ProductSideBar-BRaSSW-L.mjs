...
import _sfc_main$3 from './svg-icon-CZ9JOHhh.mjs';
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<ul${ssrRenderAttrs(mergeProps({ class: "product-info-list" }, _attrs))} data-v-3b67d8de><!--[-->`);
  ssrRenderList($props.infoList, (item, index) => {
    _push(`<li class="product-info-list__item" data-v-3b67d8de><span data-v-3b67d8de>${ssrInterpolate(item.key)}</span><span class="${ssrRenderClass({ bold: $props.isBold })}" data-v-3b67d8de>${ssrInterpolate(item.value)}</span></li>`);
  });
  _push(`<!--]--></ul>`);
}
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-3b67d8de"]]);
const _sfc_main = {
  props: {
    sideInfoList: {
      type: Array,
...
//# sourceMappingURL=ProductSideBar-BRaSSW-L.mjs.map
