...
import { _ as __nuxt_component_3$2 } from './ProductSliderSection-DYbS3d1V.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_product_slider_section = __nuxt_component_3$2;
  _push(`<main${ssrRenderAttrs(mergeProps({ class: "main" }, _attrs))} data-v-722ceb7b>`);
  ...
  _push(ssrRenderComponent(_component_the_section, { class: "catalog-category" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="catalog-category__wrap" data-v-722ceb7b${_scopeId}><aside class="catalog-category__aside" data-v-722ceb7b${_scopeId}><div class="catalog-category__filter" data-v-722ceb7b${_scopeId}>`);
        ...
        _push2(`</div></aside><div class="catalog-category__grid" data-v-722ceb7b${_scopeId}>`);
        _push2(ssrRenderComponent(_component_product_grid, { "product-list": $data.products }, null, _parent2, _scopeId));
        _push2(`</div><div class="catalog-category__pagination" data-v-722ceb7b${_scopeId}>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-722ceb7b"]]);

export { index as default };
//# sourceMappingURL=index-C3L6Qmp3.mjs.map
