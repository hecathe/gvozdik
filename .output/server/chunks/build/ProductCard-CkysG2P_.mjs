...
import _sfc_main$2 from './svg-icon-C1IWtUPM.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_svg_icon = _sfc_main$2;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "product-card" }, _attrs))} data-v-25cd1617><swiper-container class="product-card__images" pagination="true" allow-touch-move="false" slides-per-view="1" data-v-25cd1617><!--[-->`);
  ssrRenderList($props.card.images, (item, index) => {
    _push(`<swiper-slide data-v-25cd1617><img class="product-card__img"${ssrRenderAttr("src", item)} alt="" data-v-25cd1617></swiper-slide>`);
  });
  _push(`<!--]--></swiper-container><div class="product-card__info" data-v-25cd1617>`);
  _push(ssrRenderComponent(_component_nuxt_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h3 class="product-card__title h3" data-v-25cd1617${_scopeId}>${ssrInterpolate($props.card.title)}</h3><span class="product-card__price" data-v-25cd1617${_scopeId}>${ssrInterpolate($props.card.price)}</span>`);
      } else {
        return [
  ...
  _push(`<div class="product-card__actions" data-v-25cd1617>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-25cd1617"]]);

export { __nuxt_component_0 as _ };
//# sourceMappingURL=ProductCard-CkysG2P_.mjs.map
