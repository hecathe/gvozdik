...
import _sfc_main$8 from './svg-icon-BE3iEZXy.mjs';
...
const __nuxt_component_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$7], ["__scopeId", "data-v-63098a25"]]);
const _sfc_main$6 = {
  props: {
    title: {
      type: String,
...
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_nuxt_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="catalog-nav-item__content" data-v-b26010b1${_scopeId}><h3 data-v-b26010b1${_scopeId}>${ssrInterpolate($props.title)}</h3>`);
        ...
        _push2(`</div><div class="catalog-nav-item__background" data-v-b26010b1${_scopeId}><img class="catalog-nav-item__img"${ssrRenderAttr("src", $props.imgUrl)} alt="" data-v-b26010b1${_scopeId}></div>`);
      } else {
        return [
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender$6], ["__scopeId", "data-v-b26010b1"]]);
const _sfc_main$5 = {
  props: {
    catalogNav: {
      type: Array,
...
const __nuxt_component_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$5], ["__scopeId", "data-v-cf963fac"]]);
const _sfc_main$4 = {
  props: {
    link: {
      type: Boolean,
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$4], ["__scopeId", "data-v-8b68e35b"]]);
const _sfc_main$3 = {
  data() {
    return {
      value: 1
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_svg_icon = _sfc_main$8;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "goods-slider-card" }, _attrs))} data-v-2415cfee><swiper-container class="goods-slider-card__images" pagination="true" pagination-clickable="true" allow-touch-move="false" data-v-2415cfee><!--[-->`);
  ssrRenderList($props.card.images, (item, index) => {
    _push(`<swiper-slide data-v-2415cfee><img class="goods-slider-card__img"${ssrRenderAttr("src", item)} alt="" data-v-2415cfee></swiper-slide>`);
  });
  _push(`<!--]--></swiper-container><div class="goods-slider-card__info" data-v-2415cfee>`);
  _push(ssrRenderComponent(_component_nuxt_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h3 class="goods-slider-card__title h3" data-v-2415cfee${_scopeId}>${ssrInterpolate($props.card.title)}</h3><span class="goods-slider-card__price" data-v-2415cfee${_scopeId}>${ssrInterpolate($props.card.price)}</span>`);
      } else {
        return [
  ...
  _push(`<div class="goods-slider-card__actions" data-v-2415cfee>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-2415cfee"]]);
const _sfc_main = {
  props: {
    cards: {
      type: Array,
...
export { __nuxt_component_0$2 as _, __nuxt_component_2$1 as a, __nuxt_component_3 as b, __nuxt_component_4 as c, __nuxt_component_2 as d };
//# sourceMappingURL=GoodsSlider-BnsJAgtN.mjs.map
