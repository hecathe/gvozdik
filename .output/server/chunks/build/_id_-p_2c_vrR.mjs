...
import { _ as __nuxt_component_2 } from './SocialList-Bm2Lwr4G.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<main${ssrRenderAttrs(mergeProps({ class: "main" }, _attrs))} data-v-bb1a7f67>`);
  ...
  _push(ssrRenderComponent(_component_the_section, { class: "news-detail" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="news-detail__wrap" data-v-bb1a7f67${_scopeId}><div class="news-detail__top" data-v-bb1a7f67${_scopeId}><h1 class="news-detail__title h1" data-v-bb1a7f67${_scopeId}>${ssrInterpolate($data.content.title)}</h1><div class="news-detail__social" data-v-bb1a7f67${_scopeId}>`);
        _push2(ssrRenderComponent(_component_social_list, {
          "social-list": $data.social,
          vertical: "",
          blue: ""
        }, null, _parent2, _scopeId));
        _push2(`</div><span class="news-detail__date grey" data-v-bb1a7f67${_scopeId}>${ssrInterpolate($data.content.date)}</span></div><div class="news-detail__text" data-v-bb1a7f67${_scopeId}>${$data.content.text}</div></div><swiper-container class="news-detail__slider news-detail-slider" navigation="true" data-v-bb1a7f67${_scopeId}><!--[-->`);
        ssrRenderList($data.content.images, (image, index) => {
          _push2(`<swiper-slide class="news-detail-slider__item" data-v-bb1a7f67${_scopeId}><img class="news-detail-slider__img"${ssrRenderAttr("src", image)} alt="" data-v-bb1a7f67${_scopeId}></swiper-slide>`);
        });
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-bb1a7f67"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-p_2c_vrR.mjs.map
