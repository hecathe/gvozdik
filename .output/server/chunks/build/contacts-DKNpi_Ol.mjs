...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<main${ssrRenderAttrs(mergeProps({ class: "main" }, _attrs))} data-v-8749cfbd>`);
  ...
  _push(ssrRenderComponent(_component_the_section, { class: "contacts" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h1 class="h1" data-v-8749cfbd${_scopeId}>\u041A\u043E\u043D\u0442\u0430\u043A\u0442\u044B</h1><div class="contacts__map-wrap" data-v-8749cfbd${_scopeId}><div class="contacts__map" data-v-8749cfbd${_scopeId}>`);
        _push2(ssrRenderComponent(_component_client_only, null, {}, _parent2, _scopeId));
        _push2(`</div><div class="contacts__sidebar" data-v-8749cfbd${_scopeId}><div class="contacts__block" data-v-8749cfbd${_scopeId}><h3 class="h3" data-v-8749cfbd${_scopeId}>\u041D\u0430\u0448 \u0430\u0434\u0440\u0435\u0441</h3><address class="contacts__link" data-v-8749cfbd${_scopeId}>\u0433. \u0421\u0430\u043D\u043A\u0442-\u041F\u0435\u0442\u0435\u0440\u0431\u0443\u0440\u0433, \u0423\u043B. \u041F\u0443\u0448\u043A\u0438\u043D\u0430, \u0434. 1</address></div><div class="contacts__block" data-v-8749cfbd${_scopeId}><h3 class="h3" data-v-8749cfbd${_scopeId}>Call-\u0446\u0435\u043D\u0442\u0440</h3><a class="contacts__link" href="tel:8 800 555 55 55" data-v-8749cfbd${_scopeId}>8 800 555 55 55</a></div><div class="contacts__block" data-v-8749cfbd${_scopeId}><h3 class="h3" data-v-8749cfbd${_scopeId}>\u042D\u043B\u0435\u043A\u0442\u0440\u043E\u043D\u043D\u0430\u044F \u043F\u043E\u0447\u0442\u0430</h3><a class="contacts__link" href="mailto:example@mail.com" data-v-8749cfbd${_scopeId}>example@mail.com</a></div></div></div>`);
      } else {
        return [
...
const contacts = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-8749cfbd"]]);

export { contacts as default };
//# sourceMappingURL=contacts-DKNpi_Ol.mjs.map
