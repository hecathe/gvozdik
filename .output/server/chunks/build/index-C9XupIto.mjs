import { _ as __nuxt_component_0 } from './Breadcrumbs-WWgVILK3.mjs';
import { _ as __nuxt_component_0$1 } from './TheSection-oCR6a-xp.mjs';
import { _ as __nuxt_component_2, a as __nuxt_component_3 } from './ProductGrid-DWM9dBBC.mjs';
import { _ as __nuxt_component_2$1 } from './Button-DuwhWeWl.mjs';
import _sfc_main$1 from './svg-icon-BRgkTEyW.mjs';
import { _ as __nuxt_component_3$1 } from './Pagination-D-3qMP2z.mjs';
import { _ as __nuxt_component_3$2, a as __nuxt_component_4 } from './ProductSlider-DdJX8s6V.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<main${ssrRenderAttrs(mergeProps({ class: "main" }, _attrs))} data-v-fc2e32a3>`);
  ...
  _push(ssrRenderComponent(_component_the_section, { class: "catalog-category" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="catalog-category__wrap" data-v-fc2e32a3${_scopeId}><div class="catalog-category__aside" data-v-fc2e32a3${_scopeId}><form class="catalog-category__filter" data-v-fc2e32a3${_scopeId}>`);
        ...
        _push2(ssrRenderComponent(_component_ui_button, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<span data-v-fc2e32a3${_scopeId2}>\u041E\u0447\u0438\u0441\u0442\u0438\u0442\u044C \u0444\u0438\u043B\u044C\u0442\u0440</span>`);
        ...
        _push2(`</form></div><div class="catalog-category__grid" data-v-fc2e32a3${_scopeId}>`);
        _push2(ssrRenderComponent(_component_product_grid, { "product-list": $data.products }, null, _parent2, _scopeId));
        _push2(`</div><div class="catalog-category__pagination" data-v-fc2e32a3${_scopeId}>`);
        ...
        return [
          createVNode("div", { class: "catalog-category__wrap" }, [
            createVNode("div", { class: "catalog-category__aside" }, [
              createVNode("form", { class: "catalog-category__filter" }, [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-fc2e32a3"]]);

export { index as default };
//# sourceMappingURL=index-C9XupIto.mjs.map
