import { _ as __nuxt_component_0$2 } from './Breadcrumbs-J2LYRQzJ.mjs';
import { _ as __nuxt_component_0$3 } from './TheSection-mbyzIumG.mjs';
import { b as __nuxt_component_2$1, _ as __nuxt_component_3 } from './ProductSideBar-D_2DREio.mjs';
import { _ as __nuxt_component_2$3 } from './client-only-BCdukaZs.mjs';
import _sfc_main$6 from './svg-icon-C_daPMru.mjs';
...
import { _ as __nuxt_component_3$3 } from './Pagination-QH4aD03V.mjs';
...
import { _ as __nuxt_component_1$1 } from './Input-BOUdI5bE.mjs';
import { _ as __nuxt_component_3$1 } from './ProductSliderSection-B9MZn30i.mjs';
...
import 'node:fs';
import 'node:url';
import './InputNumber-Mq9Yh5wL.mjs';
import 'unhead';
import '@unhead/shared';
import 'vue-router';
import 'swiper/element/bundle';
import './ProductSlider-Bk547R3M.mjs';
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<ul${ssrRenderAttrs(mergeProps({ class: "reviews-list" }, _attrs))} data-v-ec5d5bc3><!--[-->`);
  ssrRenderList($props.reviewsList, (reviewsCard, index) => {
    _push(`<li class="reviews-list__item" data-v-ec5d5bc3>`);
    _push(ssrRenderComponent(_component_reviews_card, { "reviews-card": reviewsCard }, null, _parent));
    _push(`</li>`);
  });
  _push(`<!--]--><li data-v-ec5d5bc3>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$4], ["__scopeId", "data-v-ec5d5bc3"]]);
const _sfc_main$3 = {
  props: {
    title: {
      type: String,
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "reviews-block" }, _attrs))} data-v-7c2093cc>`);
  _push(ssrRenderComponent(_component_reviews_list, { "reviews-list": $props.reviewsList }, null, _parent));
  _push(`<div class="reviews-block__btns" data-v-7c2093cc>`);
  ...
  _push(ssrRenderComponent(_component_app_modal, {
    ...
    opened: $data.modalLeaveReviewOpened
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="modal__rating" data-v-7c2093cc${_scopeId}>`);
        _push2(ssrRenderComponent(_component_ClientOnly, null, {}, _parent2, _scopeId));
        _push2(`</div>`);
        _push2(ssrRenderComponent(_component_app_form, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<ul class="form__list" data-v-7c2093cc${_scopeId2}><li class="form__item form__item_full" data-v-7c2093cc${_scopeId2}>`);
              _push3(ssrRenderComponent(_component_ui_input, {
                type: "text",
                label: "\u0424\u0418\u041E"
              }, null, _parent3, _scopeId2));
              _push3(`</li><li class="form__item" data-v-7c2093cc${_scopeId2}>`);
              _push3(ssrRenderComponent(_component_ui_input, {
                type: "tel",
              ...
              _push3(`</li><li class="form__item form__item_full" data-v-7c2093cc${_scopeId2}>`);
              _push3(ssrRenderComponent(_component_ui_textarea, { label: "\u0414\u043E\u0441\u0442\u043E\u0438\u043D\u0441\u0442\u0432\u0430" }, null, _parent3, _scopeId2));
              _push3(`</li><li class="form__item form__item_full" data-v-7c2093cc${_scopeId2}>`);
              _push3(ssrRenderComponent(_component_ui_textarea, { label: "\u041D\u0435\u0434\u043E\u0441\u0442\u0430\u0442\u043A\u0438" }, null, _parent3, _scopeId2));
              _push3(`</li><li class="form__item form__item_full" data-v-7c2093cc${_scopeId2}>`);
              _push3(ssrRenderComponent(_component_ui_textarea, { label: "\u041A\u043E\u043C\u043C\u0435\u043D\u0442\u0430\u0440\u0438\u0439" }, null, _parent3, _scopeId2));
              _push3(`</li></ul>`);
            } else {
              return [
                createVNode("ul", { class: "form__list" }, [
                  ...
                  createVNode("li", { class: "form__item form__item_full" }, [
                    createVNode(_component_ui_textarea, { label: "\u0414\u043E\u0441\u0442\u043E\u0438\u043D\u0441\u0442\u0432\u0430" })
                  ]),
                  createVNode("li", { class: "form__item form__item_full" }, [
                    createVNode(_component_ui_textarea, { label: "\u041D\u0435\u0434\u043E\u0441\u0442\u0430\u0442\u043A\u0438" })
                  ]),
                  createVNode("li", { class: "form__item form__item_full" }, [
                    createVNode(_component_ui_textarea, { label: "\u041A\u043E\u043C\u043C\u0435\u043D\u0442\u0430\u0440\u0438\u0439" })
                  ])
                ])
              ];
            }
  ...
  _push(ssrRenderComponent(_component_app_modal, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<form class="form" data-v-7c2093cc${_scopeId}><ul class="form__list" data-v-7c2093cc${_scopeId}><li class="form__item form__item_full" data-v-7c2093cc${_scopeId}>`);
        _push2(ssrRenderComponent(_component_ui_input, {
          type: "text",
          label: "\u0424\u0418\u041E"
        }, null, _parent2, _scopeId));
        _push2(`</li><li class="form__item" data-v-7c2093cc${_scopeId}>`);
        _push2(ssrRenderComponent(_component_ui_input, {
          type: "tel",
          label: "\u041D\u043E\u043C\u0435\u0440 \u0442\u0435\u043B\u0435\u0444\u043E\u043D\u0430"
        }, null, _parent2, _scopeId));
        ...
        _push2(`</li><li class="form__item form__item_full" data-v-7c2093cc${_scopeId}>`);
        _push2(ssrRenderComponent(_component_ui_textarea, { label: "\u0412\u043E\u043F\u0440\u043E\u0441" }, null, _parent2, _scopeId));
        _push2(`</li></ul>`);
        ...
        return [
          createVNode("form", { class: "form" }, [
            createVNode("ul", { class: "form__list" }, [
              ...
              createVNode("li", { class: "form__item form__item_full" }, [
                createVNode(_component_ui_textarea, { label: "\u0412\u043E\u043F\u0440\u043E\u0441" })
              ])
            ]),
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-7c2093cc"]]);
const _sfc_main$1 = {
...
//# sourceMappingURL=_id_-41rHm3Y8.mjs.map
