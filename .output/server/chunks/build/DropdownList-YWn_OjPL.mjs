...
import { _ as __nuxt_component_1$2 } from './InputNumber-Mq9Yh5wL.mjs';
import { _ as __nuxt_component_2$1 } from './Button-DuwhWeWl.mjs';
import _sfc_main$9 from './svg-icon-C_daPMru.mjs';
...
import { _ as __nuxt_component_3$1 } from './Pagination-QH4aD03V.mjs';
...
function _sfc_ssrRender$7(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<ul${ssrRenderAttrs(mergeProps({ class: "product-grid" }, _attrs))} data-v-18867731><!--[-->`);
  ssrRenderList($props.productList, (product, index) => {
    _push(`<li class="${ssrRenderClass([{ "span-2": product.span }, "product-grid__item"])}" data-v-18867731>`);
...
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$7], ["__scopeId", "data-v-18867731"]]);
const _sfc_main$6 = {
  props: {
    products: {
      type: Array,
...
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_product_grid = __nuxt_component_1$1;
  ...
  _push(ssrRenderComponent(_component_the_section, mergeProps({ class: "catalog-category" }, _attrs), {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="catalog-category__wrap" data-v-4dc537be${_scopeId}><aside class="catalog-category__aside" data-v-4dc537be${_scopeId}><div class="catalog-category__filter" data-v-4dc537be${_scopeId}>`);
        ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent2, _scopeId);
        _push2(`</div></aside><div class="catalog-category__grid" data-v-4dc537be${_scopeId}>`);
        _push2(ssrRenderComponent(_component_product_grid, { "product-list": $props.products }, null, _parent2, _scopeId));
        _push2(`</div><div class="catalog-category__pagination" data-v-4dc537be${_scopeId}>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender$6], ["__scopeId", "data-v-4dc537be"]]);
const _sfc_main$5 = {
  props: {
    label: {
      type: String,
...
//# sourceMappingURL=DropdownList-YWn_OjPL.mjs.map
