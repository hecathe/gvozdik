...
import { _ as __nuxt_component_2 } from './SocialList-CYqsz1Py.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<main${ssrRenderAttrs(mergeProps({ class: "main" }, _attrs))} data-v-9ffedaf3>`);
  ...
  _push(ssrRenderComponent(_component_the_section, { class: "news-detail" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="news-detail__wrap" data-v-9ffedaf3${_scopeId}><div class="news-detail__content" data-v-9ffedaf3${_scopeId}><h1 class="news-detail__title h1" data-v-9ffedaf3${_scopeId}>${ssrInterpolate($data.content.title)}</h1><span class="news-detail__date grey" data-v-9ffedaf3${_scopeId}>${ssrInterpolate($data.content.date)}</span><div class="news-detail__text" data-v-9ffedaf3${_scopeId}>${$data.content.text}</div></div><div class="news-detail__aside" data-v-9ffedaf3${_scopeId}>`);
        _push2(ssrRenderComponent(_component_social_list, {
          "social-list": $data.social,
          vertical: "",
          blue: ""
        }, null, _parent2, _scopeId));
        _push2(`</div></div><swiper-container class="news-detail__slider news-detail-slider" navigation="true" data-v-9ffedaf3${_scopeId}><!--[-->`);
        ssrRenderList($data.content.images, (image, index) => {
          _push2(`<swiper-slide class="news-detail-slider__item" data-v-9ffedaf3${_scopeId}><img class="news-detail-slider__img"${ssrRenderAttr("src", image)} alt="" data-v-9ffedaf3${_scopeId}></swiper-slide>`);
        });
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-9ffedaf3"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-COz91vdZ.mjs.map
