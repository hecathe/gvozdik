...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_nuxt_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="catalog-nav-item__content" data-v-30986248${_scopeId}><h3 data-v-30986248${_scopeId}>${ssrInterpolate($props.title)}</h3>`);
        ...
        _push2(`</div><div class="catalog-nav-item__background" data-v-30986248${_scopeId}><img class="catalog-nav-item__img"${ssrRenderAttr("src", $props.imgUrl)} alt="" data-v-30986248${_scopeId}></div>`);
      } else {
        return [
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-30986248"]]);
const _sfc_main = {
  props: {
    catalogNav: {
      type: Array,
...
//# sourceMappingURL=CatalogNav-DbNWYANY.mjs.map
