...
function _sfc_ssrRender$b(_ctx, _push, _parent, _attrs) {
  const _component_svg_icon = _sfc_main$c;
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["ssrRender", _sfc_ssrRender$b], ["__scopeId", "data-v-5cd7d435"]]);
const _sfc_main$a = {
  props: {
    navList: {
      type: Array,
...
function _sfc_ssrRender$a(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<nav${ssrRenderAttrs(mergeProps({ class: "nav" }, _attrs))} data-v-5551d2f9><ul class="nav__list" data-v-5551d2f9><!--[-->`);
  ssrRenderList($props.navList, (navItem, index) => {
    _push(`<li class="nav__item" data-v-5551d2f9>`);
    _push(ssrRenderComponent(_component_nuxt_link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`${ssrInterpolate(navItem)}`);
        } else {
          return [
            createTextVNode(toDisplayString(navItem), 1)
          ];
        }
      }),
      _: 2
...
const __nuxt_component_2$2 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$a], ["__scopeId", "data-v-5551d2f9"]]);
const _sfc_main$9 = {};
...
const __nuxt_component_3$2 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$9], ["__scopeId", "data-v-501cb9e3"]]);
const _sfc_main$8 = {
  props: {
    userActions: {
      type: Array,
...
const __nuxt_component_4$1 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$8], ["__scopeId", "data-v-f4b0051d"]]);
const _sfc_main$7 = {
  props: {
    asideMenu: {
      type: Array,
...
const __nuxt_component_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$7], ["__scopeId", "data-v-a6113d63"]]);
const _sfc_main$6 = {
  props: {
    navList: {
      type: Array,
...
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_AppMenu = __nuxt_component_2$1;
  _push(`<header${ssrRenderAttrs(mergeProps({ class: "header" }, _attrs))} data-v-516dce12><div class="container" data-v-516dce12><div class="header__top" data-v-516dce12>`);
  _push(ssrRenderComponent(_component_nuxt_link, {
    to: "/",
    class: "header__logo"
  }, {
  ...
  _push(`<a class="header__phone" href="tel:8 800 555 55 55" data-v-516dce12>8 800 555 55 55</a></div><div class="header__bottom" data-v-516dce12><div class="header__wrap" data-v-516dce12><button class="header__catalog-btn" data-v-516dce12>`);
  _push(ssrRenderComponent(_component_svg_icon, {
    width: "24",
    height: "24",
    name: "more-grid"
  }, null, _parent));
  _push(`<span data-v-516dce12>\u041A\u0430\u0442\u0430\u043B\u043E\u0433</span></button>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender$6], ["__scopeId", "data-v-516dce12"]]);
const _sfc_main$5 = {
  props: {
    socialList: {
      type: Array,
...
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_svg_icon = _sfc_main$c;
  _push(`<ul${ssrRenderAttrs(mergeProps({ class: "social-list" }, _attrs))} data-v-d4b171ad><!--[-->`);
  ssrRenderList($props.socialList, (item, index) => {
    _push(`<li class="social-list__item" data-v-d4b171ad><!--[-->`);
    ssrRenderList(Object.entries(item), (obj, index2) => {
      _push(`<a class="social-list__link"${ssrRenderAttr("href", obj[1])} data-v-d4b171ad>`);
      _push(ssrRenderComponent(_component_svg_icon, {
        name: obj[0],
        width: "24",
        height: "24"
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$5], ["__scopeId", "data-v-d4b171ad"]]);
const _sfc_main$4 = {
  props: {
    navList: {
      type: Array,
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_nuxt_link = __nuxt_component_0$1;
  _push(`<ul${ssrRenderAttrs(mergeProps({ class: "footer-menu" }, _attrs))} data-v-4e68fcfb><!--[-->`);
  ssrRenderList($props.footerMenu, (item, index) => {
    _push(`<li class="footer-menu__item" data-v-4e68fcfb>`);
    _push(ssrRenderComponent(_component_nuxt_link, {
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-4e68fcfb"]]);
const _sfc_main$2 = {
  props: {
    paymentList: {
      type: Array,
