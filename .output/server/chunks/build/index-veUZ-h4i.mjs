...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<main${ssrRenderAttrs(mergeProps({ class: "main" }, _attrs))} data-v-f29337ce>`);
  ...
  _push(ssrRenderComponent(_component_the_section, { class: "catalog-category" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="catalog-category__wrap" data-v-f29337ce${_scopeId}><div class="catalog-category__aside" data-v-f29337ce${_scopeId}><div class="catalog-category__filter" data-v-f29337ce${_scopeId}>`);
        ...
        _push2(`</div></div><div class="catalog-category__grid" data-v-f29337ce${_scopeId}>`);
        _push2(ssrRenderComponent(_component_product_grid, { "product-list": $data.products }, null, _parent2, _scopeId));
        _push2(`</div><div class="catalog-category__pagination" data-v-f29337ce${_scopeId}>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-f29337ce"]]);

export { index as default };
//# sourceMappingURL=index-veUZ-h4i.mjs.map
