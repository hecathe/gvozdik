import { _ as __nuxt_component_0$1 } from './Breadcrumbs-TUy6Em1J.mjs';
import { _ as __nuxt_component_0$2 } from './TheSection-mbyzIumG.mjs';
import { b as __nuxt_component_2, _ as __nuxt_component_3 } from './ProductSideBar-BAYPIg7V.mjs';
import _sfc_main$4 from './svg-icon-CbNtY1Rj.mjs';
...
import { _ as __nuxt_component_1$1, a as __nuxt_component_2$1 } from './ProductSlider-F7xwOJk-.mjs';
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "reviews-card" }, _attrs))} data-v-b464f1c9><div class="reviews-card__top" data-v-b464f1c9><div data-v-b464f1c9><div class="reviews-card__name" data-v-b464f1c9>${ssrInterpolate($props.reviewsCard.name)}</div><div class="reviews-card__date" data-v-b464f1c9>${ssrInterpolate($props.reviewsCard.date)}</div></div><ul class="reviews-card__stars" data-v-b464f1c9><!--[-->`);
  ssrRenderList(5, (star, index) => {
    _push(`<li class="reviews-card__star" data-v-b464f1c9>`);
  ...
  _push(`<!--]--></ul></div><div class="reviews-card__block" data-v-b464f1c9><h3 data-v-b464f1c9>${ssrInterpolate($props.reviewsCard.advantages.title)}</h3><div data-v-b464f1c9>${$props.reviewsCard.advantages.text}</div></div><div class="reviews-card__block" data-v-b464f1c9><h3 data-v-b464f1c9>${ssrInterpolate($props.reviewsCard.disadvantages.title)}</h3><div data-v-b464f1c9>${$props.reviewsCard.disadvantages.text}</div></div><div class="reviews-card__block" data-v-b464f1c9><h3 data-v-b464f1c9>${ssrInterpolate($props.reviewsCard.comment.title)}</h3><div data-v-b464f1c9>${$props.reviewsCard.comment.text}</div></div><div class="reviews-card__slider" data-v-b464f1c9><swiper-container class="reviews-card__container" slides-per-view="6" space-between="20"${ssrRenderAttr("navigation-prev-el", `.custom-prev-button-${$props.reviewsCard.id}`)}${ssrRenderAttr("navigation-next-el", `.custom-next-button-${$props.reviewsCard.id}`)} data-v-b464f1c9><!--[-->`);
  ssrRenderList($props.reviewsCard.images, (image, index) => {
    _push(`<swiper-slide class="reviews-card__slide-item" data-v-b464f1c9><div class="reviews-card__img" data-v-b464f1c9><img${ssrRenderAttr("src", image)} alt="" data-v-b464f1c9></div></swiper-slide>`);
  });
  _push(`<!--]--></swiper-container><div class="${ssrRenderClass(`custom-button custom-prev-button custom-prev-button-${$props.reviewsCard.id}`)}" data-v-b464f1c9>`);
  _push(ssrRenderComponent(_component_svg_icon, {
    name: "arrow-left",
    width: "24",
    height: "24"
  }, null, _parent));
  _push(`</div><div class="${ssrRenderClass(`custom-button custom-next-button custom-next-button-${$props.reviewsCard.id}`)}" data-v-b464f1c9>`);
  _push(ssrRenderComponent(_component_svg_icon, {
    name: "arrow-right",
    width: "24",
    height: "24"
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-b464f1c9"]]);
const _sfc_main$2 = {
  props: {
    reviewsList: {
      type: Array,
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "tabs" }, _attrs))} data-v-e9728c2a><ul class="tabs__list" data-v-e9728c2a><!--[-->`);
  ssrRenderList($props.tabs, (tab) => {
    _push(`<li class="tabs__item" data-v-e9728c2a><button class="${ssrRenderClass([{ active: $data.activeTab === tab.id }, "tabs__btn"])}" data-v-e9728c2a>${ssrInterpolate(tab.title)}</button></li>`);
  });
  _push(`<!--]--></ul><div class="tabs__body" data-v-e9728c2a><!--[-->`);
  ssrRenderList($props.tabs, (tab) => {
    _push(`<div class="tabs__content" style="${ssrRenderStyle($data.activeTab === tab.id ? null : { display: "none" })}" data-v-e9728c2a>`);
    if (tab.id == 1) {
      _push(`<div data-v-e9728c2a>${tab.content}</div>`);
    } else if (tab.id == 2) {
      _push(`<div data-v-e9728c2a>`);
      _push(ssrRenderComponent(_component_product_info_list, {
        "info-list": tab.content
      }, null, _parent));
      _push(`</div>`);
    } else if (tab.id == 3) {
      _push(`<div class="tabs__reviews" data-v-e9728c2a>`);
      _push(ssrRenderComponent(_component_reviews_list, {
        "reviews-list": tab.content
      }, null, _parent));
      _push(`<div class="tabs__reviews-btns" data-v-e9728c2a>`);
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-e9728c2a"]]);
const _sfc_main = {
  data() {
    return {
      breadcrumbs: [
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<main${ssrRenderAttrs(mergeProps({ class: "main" }, _attrs))} data-v-565fa74a>`);
  ...
  _push(ssrRenderComponent(_component_the_section, { class: "product-section" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h1 class="h1" data-v-565fa74a${_scopeId}>\u041A\u043B\u0435\u0449\u0438 \u043F\u0435\u0440\u0435\u0441\u0442\u0430\u0432\u043D\u044B\u0435 Sparta 250 \u043C\u043C</h1><div class="product-section__wrap" data-v-565fa74a${_scopeId}><div class="product-section__slider" data-v-565fa74a${_scopeId}><swiper-container class="product-section__slider-container" slides-per-view="1" pagination="true" data-v-565fa74a${_scopeId}><!--[-->`);
        ssrRenderList($data.images, (item, index) => {
          _push2(`<swiper-slide class="product-section__slider-item" data-v-565fa74a${_scopeId}><div class="product-section__img" data-v-565fa74a${_scopeId}><img${ssrRenderAttr("src", item)} alt="" data-v-565fa74a${_scopeId}></div></swiper-slide>`);
        });
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-565fa74a"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-gx4rBtY2.mjs.map
