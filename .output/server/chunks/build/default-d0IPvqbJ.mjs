import _sfc_main$g from './svg-icon-C_daPMru.mjs';
...
import { _ as __nuxt_component_1$2 } from './Input-BOUdI5bE.mjs';
import { _ as __nuxt_component_2$3 } from './Button-DuwhWeWl.mjs';
import { _ as __nuxt_component_2$4 } from './SocialList-CFUEc8JF.mjs';
import '../runtime.mjs';
import 'node:http';
import 'node:https';
import 'fs';
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_nuxt_link = __nuxt_component_0$2;
  _push(`<ul${ssrRenderAttrs(mergeProps({ class: "footer-menu" }, _attrs))} data-v-a8e0692d><!--[-->`);
  ssrRenderList($props.footerMenu, (item, index) => {
    _push(`<li class="footer-menu__item" data-v-a8e0692d>`);
    _push(ssrRenderComponent(_component_nuxt_link, {
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-a8e0692d"]]);
const _sfc_main$2 = {
  props: {
    paymentList: {
      type: Array,
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "footer" }, _attrs))} data-v-9830da79><div class="container" data-v-9830da79><div class="footer__top" data-v-9830da79><div class="footer__block" data-v-9830da79>`);
  _push(ssrRenderComponent(_component_nuxt_link, {
    to: "/",
    class: "footer__logo"
  }, {
  ...
  _push(`<a class="footer__tel" href="tel:8 800 555 55 55" data-v-9830da79>8 800 555 55 55</a>`);
  _push(ssrRenderComponent(_component_social_list, { "social-list": $props.socialList }, null, _parent));
  _push(`</div><div class="footer__block" data-v-9830da79><h3 class="footer__title" data-v-9830da79>\u041A\u0430\u0442\u0430\u043B\u043E\u0433</h3>`);
  _push(ssrRenderComponent(_component_AppFooterNav, { "nav-list": $props.navList }, null, _parent));
  _push(`</div><div class="footer__block" data-v-9830da79>`);
  _push(ssrRenderComponent(_component_AppFooterMenu, { "footer-menu": $props.footerMenu }, null, _parent));
  _push(`</div></div><div class="footer__bottom" data-v-9830da79><div class="footer__block" data-v-9830da79><span data-v-9830da79>\xA9 2024 \xAB\u0413\u0432\u043E\u0437\u0434\u0438\u043A\xBB</span>`);
  _push(ssrRenderComponent(_component_nuxt_link, {
    class: "footer__link",
    to: "#"
  }, {
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-9830da79"]]);
const _sfc_main = {
  data() {
    return {
      menu: [
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--[--><div class="top" data-v-c0b5591e>`);
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-c0b5591e"]]);

export { _default as default };
//# sourceMappingURL=default-d0IPvqbJ.mjs.map
