...
import { b as __nuxt_component_0$3 } from './ProductSlider-D6J6YCtc.mjs';
...
import _sfc_main$8 from './svg-icon-BopcabGT.mjs';
...
function _sfc_ssrRender$7(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_product_card = __nuxt_component_0$3;
...
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_the_section, mergeProps({ class: "catalog-category" }, _attrs), {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="catalog-category__wrap" data-v-7fcba8e0${_scopeId}><aside class="catalog-category__aside" data-v-7fcba8e0${_scopeId}><div class="catalog-category__filter" data-v-7fcba8e0${_scopeId}>`);
        ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent2, _scopeId);
        _push2(`</div></aside><div class="catalog-category__grid" data-v-7fcba8e0${_scopeId}>`);
        _push2(ssrRenderComponent(_component_product_grid, { "product-list": $props.products }, null, _parent2, _scopeId));
        _push2(`</div><div class="catalog-category__pagination" data-v-7fcba8e0${_scopeId}>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender$6], ["__scopeId", "data-v-7fcba8e0"]]);
const _sfc_main$5 = {
  props: {
    label: {
      type: String,
...
//# sourceMappingURL=DropdownList-Bhz3javb.mjs.map
