import _sfc_main$1 from './svg-icon-C1IWtUPM.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))} data-v-2be5b743><!--[-->`);
  ssrRenderList($props.socialList, (item, index) => {
    _push(`<li class="social-list__item" data-v-2be5b743><!--[-->`);
    ssrRenderList(Object.entries(item), (obj, index2) => {
      _push(`<a class="${ssrRenderClass([{ blue: $props.blue }, "social-list__link"])}"${ssrRenderAttr("href", obj[1])} data-v-2be5b743>`);
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-2be5b743"]]);

export { __nuxt_component_2 as _ };
//# sourceMappingURL=SocialList-DIV1iqzs.mjs.map
